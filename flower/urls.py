...
handlers = [
    ...
    (r"/api/aws/sso/start", aws_api.StartAwsSsoLogin),
    (r"/api/aws/sso/complete", aws_api.CompleteAwsSsoLogin),
    (r"/api/aws/ecs/clusters", aws_api.ListEcsClusters),
    (r"/api/aws/ecs/services", aws_api.ListEcsServices),
    (r"/api/aws/ecs/worker-service", aws_api.GetEcsWorkerService),
